...
// Jika tidak ada pemilu aktif, redirect
if (!$active_election) {
...
// Query kandidat untuk pemilu aktif
if (!empty($search)) {
    ...
    mysqli_stmt_bind_param($stmt, "iss", $active_election['id_election'], $search_param, $search_param);
} else {
    $query = "SELECT * FROM kandidat 
              WHERE id_election = ? 
              ORDER BY nomor_urut ASC";
                    ...
                    <div class="kandidat-card">
                        ...
                        <div class="kandidat-body">
                            ...
                            <div class="kandidat-actions">
                                <button onclick="confirmVote(<?php echo $row['id_kandidat']; ?>, '<?php echo $row['nama_kandidat']; ?>', <?php echo $row['nomor_urut']; ?>, <?php echo $active_election['id_election']; ?>)" 
                                        class="btn-pilih">
                                    ✅ Pilih Kandidat Ini
                                </button>
                            </div>
    ...
    <div id="modalKonfirmasi" class="modal">
        <div class="modal-content">
            ...
            <div style="text-align: center; padding: 20px;">
                ...
                <h3 style="margin-bottom: 15px;">Apakah Anda yakin memilih:</h3>
                <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 15px; margin: 20px 0;">
                    ...
                    <h3 style="margin: 10px 0 0 0;" id="modalNama"></h3>
                </div>
